...
//    }
    ...
    public boolean isClubContainsBook(Club club, Book book, User user) {
        return cbuRepository.existsByClubAndBookAndUser(club, book, user);
    }

    public List<ClubBookUser> findByClubIsNotNullAndBookAndUser(Book book, User user) {
        return cbuRepository.findByClubIsNotNullAndBookAndUser(book, user);
    }
}
